...
import ImageHoster.validator.PasswordValidator;
...
public class UserController {
    ...
    public String registerUser(User user,RedirectAttributes redirectAttributes) {
    	...
    	boolean isValid = validator.validate(user.getPassword());
    	if(!isValid) {
    		redirectAttributes.addAttribute("passwordTypeError", "true");
